package com.bounce.notemate.presentation.create_notes
...
import com.akshatbhuhagal.notemate.presentation.create_notes.CreateNoteViewModel
import com.akshatbhuhagal.notemate.presentation.create_notes.NoteBottomSheetFragment
import com.bounce.notemate.R
import com.bounce.notemate.databinding.FragmentCreateNoteBinding
import com.bounce.notemate.util.extensions.EMPTY_STRING
import com.bounce.notemate.util.extensions.makeGone
import com.bounce.notemate.util.extensions.makeVisible
...
class CreateNoteFragment :
    ...
    private fun collectNotes() {
        viewModel.getNoteById(param1 ?: 0)
    ...
    private fun initViews() = binding.apply {
        ...
        imgDone.setOnClickListener {
            viewLifecycleOwner.lifecycleScope.launch {
                viewModel.getNoteLiveData().value?.let {
                    updateNote(it)
                } ?: saveNote()
            }
        }
        ...
        imgMore.setOnClickListener {
            val noteBottomSheetFragment =
                NoteBottomSheetFragment.newInstance(param1)
